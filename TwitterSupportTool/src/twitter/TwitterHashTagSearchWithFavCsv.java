...
public class TwitterHashTagSearchWithFavCsv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("# ======== Generate csv START for : "+searchTarget+" & favcnt="+favcount);
		...
		System.out.println("# ======== Generate csv END for : "+searchTarget);
	}
}
